...
def talk():
    # トーク
    answer = player.talk()
    return render_template("game.html", message="話しかけた", neet_answer=answer, money=player.money,
                           fatigue=player.mother_fatigue, time="仕事前")
...
def feed():
    ...
    return render_template("game.html", message=food_id + "を与えた", neet_answer="", money=player.money,
                           fatigue=player.mother_fatigue, time="仕事前")
...
def buy():
    ...
    return render_template("game.html", message=buy_id + "を与えた", neet_answer="", money=player.money,
                           fatigue=player.mother_fatigue, time="仕事前")
